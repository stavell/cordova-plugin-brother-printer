...
public class BrotherLabelPrinter {
    ...
    BrotherLabelPrinter(Context ctx, String printerModel, String orientation, String printMode, int scaleValue, boolean isAutoCut, boolean isLabelEndCut, boolean isSpecialTape, String labelName) {
        this.context = ctx;
